...
(
    ...
    `oper_user_id`   varchar(32)  NOT NULL DEFAULT '' COMMENT '操作用户ID',
    `oper_use_name`  varchar(128) NOT NULL DEFAULT '' COMMENT '操作用户名称',
...
INSERT INTO shop.sys_resource (id, resource_id, resource_name, parent_resource_id, sort, url, resource_type, visible,
                               perms,
...
INSERT INTO shop.sys_role (id, role_id, role_name, role_key, sort, tenant_id, deleted_flag, create_time, update_time)
...
-- sys_role_resource: table
CREATE TABLE `sys_sys_role_resource`
(
    `id`          int         NOT NULL AUTO_INCREMENT COMMENT '主键',
    `role_id`     varchar(32) NOT NULL COMMENT '角色ID',
    `resource_id` varchar(32) NOT NULL COMMENT '资源ID',
...
INSERT INTO shop.sys_role_resource (id, role_id, resource_id, tenant_id)
...
INSERT INTO sys_tenant (id, tenant_id, root_user_id, status, deleted_flag, create_time, update_time)
...
INSERT INTO sys_user (id, user_id, name, email, phonenumber, gender, avatar, password, salt, login_ip, login_date,
...
INSERT INTO shop.sys_user_role (id, user_id, role_id, tenant_id)
