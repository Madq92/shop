...
public class ProdCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // Web层
        pathInfoMap.put(OutputFile.controller, DIR + "/shop-web/src/main/java/tech/oldhorse/shop/web/controller/prod");

        // Dao层
        pathInfoMap.put(OutputFile.serviceImpl, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/prod/repository/impl");
        pathInfoMap.put(OutputFile.service, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/prod/repository");
        pathInfoMap.put(OutputFile.entity, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/prod/entity");
        pathInfoMap.put(OutputFile.mapper, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/prod/mapper");
        pathInfoMap.put(OutputFile.xml, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/prod/mapper/xml");
        ...
        FastAutoGenerator.create(DB_URL, USER_NAME, PASSWORD)
                ...
                .packageConfig(builder -> builder.parent("tech.oldhorse.shop")
                        .entity("dao.prod.entity")
                        .mapper("dao.prod.mapper")
                        .service("dao.prod.repository")
                        .serviceImpl("dao.prod.repository.impl")
                        .controller("web.controller.prod")
