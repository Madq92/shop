...
//        pathInfoMap.put(OutputFile.controller, DIR + "/shop-web/src/main/java/tech/oldhorse/shop/web/controller");
        ...
        // Dao层
        pathInfoMap.put(OutputFile.serviceImpl, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/sys/repository/impl");
        pathInfoMap.put(OutputFile.service, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/sys/repository");
        pathInfoMap.put(OutputFile.entity, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/sys/entity");
        pathInfoMap.put(OutputFile.mapper, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/sys/mapper");
        pathInfoMap.put(OutputFile.xml, DIR + "/shop-dao/src/main/java/tech/oldhorse/shop/dao/sys/mapper/xml");
        ...
        FastAutoGenerator.create(DB_URL, USER_NAME, PASSWORD)
                ...
                .packageConfig(builder -> builder.parent("tech.oldhorse.shop")
                        .entity("dao.entity")
                        .mapper("dao.mapper")
                        .service("dao.sys.repository")
                        .serviceImpl("dao.sys.repository.impl")
                        .controller("web.controller.sys")
